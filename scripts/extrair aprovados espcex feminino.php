...
$inputFile = __DIR__ . '/../unworken data/aprovados espcex feminino.txt';
$outputFile = __DIR__ . '/../data/espcex/resultado feminino.json';
...
$tokens = explode('INSCRIÇÃO NOME', $txtEspcex);
